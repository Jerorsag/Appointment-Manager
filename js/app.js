...
class AdminCitas {
    ...
    mostrar() {
        ...
        this.citas.forEach(cita => {
            ...
            deporte.innerHTML = `<span class="font-bold uppercase">Deporte: </span> ${cita.deporte}`;
            ...
            fecha.innerHTML = `<span class="font-bold uppercase">¿Cuando empezo el problema?: </span> ${cita.fecha}`;
